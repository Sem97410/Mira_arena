...
@onready var minimap_indicator_close_size_vector : Vector3 = Vector3(minimap_indicator_close_size,minimap_indicator_close_size,minimap_indicator_close_size)
@onready var minimap_indicator_far_size_vector  : Vector3 = Vector3(minimap_indicator_far_size,minimap_indicator_far_size,minimap_indicator_far_size)
